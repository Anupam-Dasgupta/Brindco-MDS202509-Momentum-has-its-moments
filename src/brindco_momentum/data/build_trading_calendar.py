...
TRI_PARQUET = ROOT / Path("data/processed/nifty500_tri_2013_2026.parquet"
)

OUTPUT = ROOT / Path("data/processed/nse_trading_calendar_2013_2026.parquet"
)

AUDIT = ROOT / Path("data/processed/trading_calendar_audit.csv"
)
